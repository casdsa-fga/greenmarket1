        ...
        if not existing:
            ...
            if referrer_id:
                ...
                if ref_exists:
                    ...
                    if not already:
                        debug("ADDING BONUS +300 +50 tickets")
                        ...
                        # ===== FINAL CHECK =====
                        c.execute("""
                            SELECT balance, tickets, invited
                            FROM users
                            WHERE user_id=?
                        """, (referrer_id,))

                        debug(f"AFTER BONUS = {c.fetchone()}")
